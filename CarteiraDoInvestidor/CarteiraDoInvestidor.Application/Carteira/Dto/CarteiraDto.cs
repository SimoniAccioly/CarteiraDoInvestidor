...
namespace CarteiraDoInvestidor.Application.Carteira.Dto
{
    ...
    public record AtivosInputDto(
        ...
        [Required(ErrorMessage = "Corretora é obrigatório")] string Corretora, double TaxaDeCorretagem, string ArquivoExcel);
    public record AtivosOutputDto(Guid Id, string Papel, int Quantidade, double PrecoMedio, string Corretora, double TaxaDeCorretagem, string ArquivoExcel);
